  ...
  return (
    <section className="mx-auto flex flex-col bg-gray-200 shadow p-12 items-center gap-2 mt-16">
      <div className="flex flex-col gap-24 w-full">
        <HomepageSection
          title="Who are we?"
          content="We are a group of enthusiasts who love books! Have you ever had a problem,
          when you couldn&apos;t get your hands on a rare book?
        ...
        <HomepageSection
          ...
          content="It&apos;s simple. You make an account, look for the book of your choice and borrow it!
          Then you get to keep it for a month,
        ...
        <HomepageSection
          ...
          rightAligned={false}
        />
        <div className="flex flex-row bg-gray-100 text-2xl shadow p-4">
          <div className="flex-col items-center">
            Our top books:
            <SliderDemo type="top" />
          </div>
          <div className="flex-col self-end justify-self-start items-center">
            Some of our books:
